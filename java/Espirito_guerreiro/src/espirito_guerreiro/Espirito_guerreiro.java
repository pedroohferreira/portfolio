    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (g1.getVidas()>0 && true == passouLvl1 && false == passouLvl2){
                int opc;
                while (true){
                    opc = InOut.leInt("LEVEL 2 - nesse nivel voce deve escolher 0 para PAR ou 1 para IMPAR");
                    if (opc != 0 && opc != 1){
                        InOut.MsgDeErro("OPCAO INVALIDA", "informe uma opcao valida ... tente novamente");
                    }
                    else{
                        break;
                    }
